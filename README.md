...
- 🔒 **現金流優先，盲測判斷**：第一步只看現金流量表數字本身，嚴禁查詢股價、EPS、產業地位，避免先入為主
- 🎭 **擬人化解讀**：把冰冷的財務數字轉譯成「老將自費特訓型」「寅吃卯糧型」等直覺標籤，先講數字現象、再給標籤、最後才給分數
- 🚦 **關卡判斷**：現金流評分低於門檻時主動建議停止深入，不強行做完整套分析
- 🔗 **來源必附連結**：任何查得的市場數據都要附上實際查詢頁面連結，可逐項覆核打勾／打叉
- 📈 **雙重估值檢視**：前瞻本益比（股價反推倍數）與目標本益比法（倍數反推目標價）並用，交叉檢視現在貴不貴
- 🧭 **可跳步、可單步執行**：可只問「法說會怎麼看」或「營收趨勢圖」，不必每次從頭走完六步
...
| `台股個股分析框架_通用版.md` | 拿掉工具專屬指令的通用版 | ChatGPT、Gemini 等所有 AI 對話介面 |
...
| Step 3 | 法說會資料深入討論 | 依公司實際內容彈性決定切入方向，不套固定題材模板 |
| Step 4 | 營收趨勢視覺化 | 近 8-12 期月營收直條圖，截圖或搜尋二選一 |
| Step 5 | 前瞻本益比／EPS 預估 | 隱含本益比＋目標本益比法雙重檢視，誠實揭露預估不確定性 |
